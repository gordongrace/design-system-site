...
A typographic scale was used to create a set of `font-size`s and `line-height`s which have been designed for legibility and can be easily be implemented by designers or developers with a predictable output.
